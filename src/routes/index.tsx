  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="gradient-hero text-primary-foreground">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 md:grid-cols-[1.2fr,1fr] md:py-28">
          <div>
            <span className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/15 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-gold">
            ...
            <p className="mt-5 max-w-xl text-base text-primary-foreground/80 md:text-lg">
              The official online portal of <strong>Zamboanga del Sur Provincial Government College — Dimataling
              Campus.</strong> Submit your application, upload requirements, and track validation in one secure place.
            </p>
            ...
            <dl className="mt-12 grid grid-cols-3 gap-6 border-t border-primary-foreground/15 pt-6 text-sm">
              {[
          ...
          <div className="relative">
            <div className="rounded-2xl border border-primary-foreground/15 bg-primary-foreground/10 p-6 backdrop-blur">
              ...
              <ol className="mt-5 space-y-5">
                {[
                  ...
                  <li key={step[0]} className="flex gap-4">
                    ...
                    <div>
                      <p className="font-semibold text-primary-foreground">{step[0]}</p>
